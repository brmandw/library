        ...
        <section class="section">
            <div class="row">
              <div class="col-lg-12">
                ...
                @include('petugas.databuku.create',  ['kategoribuku' => $kategoribuku])
                <div class="card">
                  <div class="card-body">
                    ...
                    <table class="table datatable">
                      <thead>
                        <tr>
                          ...
                          <th class="text-center align-middle" style="width: 150px">Kode</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-center align-middle" style="width: 150px">{{$buku->penerbit}}</td>
                          <td class="text-center align-middle" style="width: 150px">{{$buku->kategoribuku ? $buku->kategoribuku->nama_kategori : '' }}</td>
                          <td class="text-center align-middle" style="width: 150px">{{$buku->tahun_terbit}}</td>
                          ...
                          <td class="text-center" style="vertical-align: middle; height: 100px;">
                            <a href="#" class="btn btn-warning mb-2" data-bs-toggle="modal" data-bs-target="#editBuku{{ $buku->id }}">
                                <i class="bi bi-pen"></i>
                            </a>
                            <br>
                        ...
                        @include('petugas.databuku.edit')
                        @include('petugas.databuku.delete')
