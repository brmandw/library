        ...
        <div class="modal-body">
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="{{ route('petugas.databuku.update', ['id' => $buku->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text-area" name="deskripsi" id="deskripsi" value="{{ old('deskripsi', $buku->deskripsi) }}">
                </div>
