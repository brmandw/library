<div class="modal fade" id="editPetugas{{ $users->id }}" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title mb-3">Data Petugas</h5>

              <form class="row g-3" action="{{ route('admin.datapetugas.update', ['id' => $users->id]) }}" method="POST">
                @csrf
                @method('PUT')
