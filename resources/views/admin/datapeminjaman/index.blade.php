...
<html lang="en">
<head>
    <title>Admin - Data Peminjaman Buku</title>
    @include('admin.head')
                    ...
                    <table class="table datatable">
                      <thead>
                        <tr>
                          ...
                          <th class="text-center align-middle" style="width: 150px">Judul Buku</th>
                          ...
                          <th class="text-center align-middle" style="width: 100px">Status Peminjaman</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                       @foreach ($peminjaman as $key => $data)
                          ...
                          <td class="text-center align-middle" style="width: 150px">{{ $data->buku->penulis }}</td>
